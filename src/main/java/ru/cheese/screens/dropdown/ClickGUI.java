package ru.cheese.screens.dropdown;
...
import ru.cheese.manager.themeManager.Style;
import ru.cheese.modules.Function;
import ru.cheese.modules.Type;
import ru.cheese.modules.setting.*;
import ru.cheese.screens.dropdown.impl.*;
import ru.cheese.screens.dropdown.search.SearchState;
import ru.cheese.util.animations.impl.EaseInOutQuad;
...
import static ru.cheese.util.render.RenderUtil.drawBlur;
...
public class ClickGUI extends Screen implements IMinecraft {
    ...
    private void renderPanel(DrawContext ctx, int x, int y, Type category, int mouseX, int mouseY) {
        ...
        for (Function f : Manager.FUNCTION_MANAGER.getFunctions(category)) {
            ...
            ru.cheese.modules.render.ClickGUI clickGUI = Manager.FUNCTION_MANAGER.clickGUI;
