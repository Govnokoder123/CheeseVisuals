package ru.cheese.manager.commandManager.impl;
...
import ru.cheese.manager.commandManager.Command;
...
public class WayPointCommand extends Command {
    ...
    private final Path FILE = Paths.get(mc.runDirectory.getAbsolutePath(), "files\\modules", "waypoints.cv");
