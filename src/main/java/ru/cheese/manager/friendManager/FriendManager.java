package ru.cheese.manager.friendManager;
...
public final class FriendManager {
    ...
    private final Path FRIENDS_FILE = Paths.get(Objects.requireNonNull(MinecraftClient.getInstance().runDirectory).getAbsolutePath(), "files", "friends.cv");
