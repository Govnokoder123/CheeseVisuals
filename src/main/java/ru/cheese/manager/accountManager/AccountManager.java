package ru.cheese.manager.accountManager;
...
public class AccountManager implements IMinecraft {
    ...
    private final File file = new File(MinecraftClient.getInstance().runDirectory, "files/alts.cv");
    private final File lastAltFile = new File(MinecraftClient.getInstance().runDirectory, "files/lastAlt.cv");
