package ru.cheese.manager.macroManager;
...
import static ru.cheese.manager.IMinecraft.mc;

public class MacroManager {
    public List<Macro> macros = new ArrayList<>();
    private static final File macroFile = new File(MinecraftClient.getInstance().runDirectory, "\\files\\macros.cv");
